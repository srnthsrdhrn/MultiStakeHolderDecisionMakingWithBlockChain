"""
Django settings for MultiStakeHolder project.
...
SECRET_KEY = 'egd=evc4q1$hb*gml(=am4*5=jd$r&g(uuv_lfs+a=g2r84-2*'
...
ROOT_URLCONF = 'MultiStakeHolder.urls'
...
WSGI_APPLICATION = 'MultiStakeHolder.wsgi.application'
